...
<article class="social-grid-post" wire:key="grid-post-{{ $post->id }}">
    <button type="button"
            class="social-grid-post-button is-{{ $post->display_format ?? 'square' }}"
            data-bs-toggle="modal"
            data-bs-target="#postModal{{ $post->id }}">
        <img src="{{ route('community.posts.photo', $post) }}" alt="Post de {{ $post->user->name }}" loading="lazy">

        <span class="social-grid-post-overlay">
            <span>
                    ...
                    <div class="social-post-detail-panel">
                        ...
                        <div class="social-comments">
                            @foreach($post->comments->reverse() as $comment)
                                ...
                                <div class="social-comment" wire:key="grid-comment-{{ $comment->id }}">
                                    ...
                                    @if($comment->replies->isNotEmpty())
                                        <div class="social-comment-replies">
                                            @foreach($comment->replies as $reply)
                                                ...
                                                <div class="social-comment reply" wire:key="grid-reply-{{ $reply->id }}">
